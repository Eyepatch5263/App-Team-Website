...
const RegistrationsMap = () => {
  ...
  //               className="announcement-card rounded-2xl p-6 border-2 border-white/15 shadow-2xl backdrop-blur-sm transition-all duration-300 hover:border-white/25 hover:shadow-xl"
  //             >
  //               {/* Header */}
  ...
  //                       {registration.rollNum}
  //                     </span>
  //                   </div>
  //                 </div>
  //                 <div className="text-right">
  //                   <span className="text-purple-300 text-xs font-medium px-2 py-1 rounded-full bg-purple-500/20 border border-purple-400/30">
  ...
  //                   </svg>
  //                   <span>{registration.mobileNum}</span>
  //                 </div>
  //               </div>
  ...
  //                     {registration.skills || 'Not specified'}
  //                   </p>
  //                 </div>
  //               )}

  //               {/* Why Join */}
  //               <div className="bg-gradient-to-br from-purple-500/10 to-pink-600/10 rounded-xl p-4 border border-purple-400/20">
  //                 <h4 className="text-purple-200 font-medium text-sm mb-2 flex items-center gap-2">
  //                   <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <>
      <div className='flex justify-center items-center text-white font-bold text-4xl min-h-screen bg-[#140b29]'>
        Page is temporarily closed
      </div>
    </>
  )
};
